package com.insigma.ordercenter.gateway.util;
...
public class RedisUtil {
     ...
     * @return
     */
    public List<Object> batchListByKeys(List<String> keys) {
        try {
            return this.redisTemplate.opsForValue().multiGet(keys);
        } catch (Exception e) {
            log.error("批量获取 redis失败:{},错误信息为:{}", keys.toString(), e.getMessage());
     ...
     * @return 值
     */
    public List<Object> hgetMapKeys(String key, List<Object> item) {
    ...
    public boolean hmset(String key, Map<Object, Object> map) {
        try {
            ...
            e.printStackTrace();
            log.error("对应多个键值:{}===={}" + e.getMessage(), e);
            return false;
        }
    }
     ...
     * @return
     */
    public boolean hsetputAll(String key, Map<String, String> map) {
