...
public class StringUtil {
    ...
    public static String addPercent(String str) {
        ...
        if (!StringUtil.isEmpty(str)) {
            str = Constant.PERCENT + str + Constant.PERCENT;
            return str;
        } else {
            return null;
        }
     ...
     *
     * @param str 要反转的字符串
     * @return java.lang.String 反转之后的字符串
     * @author Pan Juncai
     ...
     * 前置填充0
     *
     * @param length 需要的字符创长度
     * @param number 需要加工的数字
     * @return java.lang.String
     * @author Pan Juncai
     * @date 2020/3/19 17:24
     */
    public static String getSerialNumberString(long length, long number) {
     ...
     * @date 2020/3/19 17:24
     */
    public static String getSerialStringStr(long length, String number) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < length - ("" + number).length(); i++) {
            sb.append(0);
        }
     ...
     */
    public static String getRandStringInLength(int length) {
     ...
     * @date 2020/4/2 17:49
     */
    public static String getRandomNumberToStr(int length) {
        Random random = new Random();
        //随机产生数字与字母组合的字符串
